...
export const getGameStateFromLevel = ({ lives, paddleWidth, speed, blocks, ballColor, paddleColor }) => {
  ...
  return {
    ...
    ...getInitialPaddleAndBall(width, height, paddleWidth, ballColor, paddleColor),
    lives,
    speed
  }
}
